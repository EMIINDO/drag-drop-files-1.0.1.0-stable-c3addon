...

{
    ...
    globalThis.C3.Plugins.StraniAnelli_DragAndDropFiles.Instance = class StraniAnelli_DragAndDropFiles_Instance extends C3.SDKDOMInstanceBase
    {
         constructor()
        {
...
const properties = this._getInitProperties();
        ...
        _OnClick(e)
        {
            ...
            this._trigger(globalThis.C3.Plugins.StraniAnelli_DragAndDropFiles.Cnds.OnClick);
        }

        _OnMouseOver(e)
        {
            this._conditions_onMouseOver = true;
            this._trigger(globalThis.C3.Plugins.StraniAnelli_DragAndDropFiles.Cnds.OnMouseOver);
        }
        ...
        {
            this._conditions_onMouseOver = false;
            this._trigger(globalThis.C3.Plugins.StraniAnelli_DragAndDropFiles.Cnds.OnMouseLeave);
        }
        ...
        async _OnDrop(e)
        {
            ...
            this._conditions_onMouseOver = true;
            this._files = e["files"];
            await this._trigger(globalThis.C3.Plugins.StraniAnelli_DragAndDropFiles.Cnds.OnDrop);
        }
        ...
        _OnDragOver(e)
        {
            ...
            this._conditions_onMouseOver = true;
            this._trigger(globalThis.C3.Plugins.StraniAnelli_DragAndDropFiles.Cnds.OnDragOver);
        }
        ...
        _OnDragEnter(e)
        {
            this._conditions_onDragOver = true;
            this._conditions_onMouseOver = true;
            this._trigger(globalThis.C3.Plugins.StraniAnelli_DragAndDropFiles.Cnds.OnDragEnter);
        }
        ...
        _OnDragLeave(e)
        {
            this._conditions_onDragOver = false;
            this._conditions_onMouseOver = false;
            this._trigger(globalThis.C3.Plugins.StraniAnelli_DragAndDropFiles.Cnds.OnDragLeave);
        }
        ...
        _OnDrag(e)
        {
            this._trigger(globalThis.C3.Plugins.StraniAnelli_DragAndDropFiles.Cnds.OnDrag);
        }


        _OnDragExit(e)
        {
            this._trigger(globalThis.C3.Plugins.StraniAnelli_DragAndDropFiles.Cnds.OnDragExit);
        }

        _OnDragStart(e)
        {
            this._trigger(globalThis.C3.Plugins.StraniAnelli_DragAndDropFiles.Cnds.OnDragStart);
        }
